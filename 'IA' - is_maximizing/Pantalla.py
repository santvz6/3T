...
class Pantalla:
    ...
    def update(self):
        ...
        ################## EVENTO (PULSAR ALGO) ################## 
            if self.cambio_pantalla == '1t':
                ...
                if event.type == pg.MOUSEBUTTONDOWN and event.button == 1:  
                    ...
                    if not self.t1_set.victoria_1t(self.t1_set.tablero)[0] and not self.t1_set.tablero_full(self.t1_set.tablero)\
                    and self.t1_set.jugar_casilla(False): # no utilizamos unicode - usamos coordenadas
                        self.t1_set.mejor_movimiento()
        ...
        ################## T1 ##################
            ...
            if not self.t1_set.victoria_1t(self.t1_set.tablero)[0] and self.t1_set.num_mov < 9:   # NO hay victoria
